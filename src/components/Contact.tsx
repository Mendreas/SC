      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Entre em contacto connosco. Estamos aqui para ajudar com todas as suas necessidades contabilísticas.
          </p>
        </div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+351911109216" className="text-gray-600 hover:text-brand-red transition-colors">
                      +351 911 109 216
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:sublinhaconta@gmail.com" className="text-gray-600 hover:text-brand-red transition-colors">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p><strong>Sublinha Conta</strong> - Contabilidade e Gestão de Empresas Lda</p>
                <p>Registada na Conservatória do Registo Comercial de Sintra</p>
                <p>NIPC: 508 072 417</p>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-brand-red text-white px-6 py-4 rounded-lg font-semibold hover:bg-red-800 transition-colors flex items-center justify-center space-x-2"
                  >
